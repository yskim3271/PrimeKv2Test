...
if __name__ == '__main__':
    ...
    parser.add_argument('--clean_wav_dir', default='/media/lz-4060ti-linux/SE/SE/VB_DEMAND_16K/clean_test')
    parser.add_argument('--noisy_wav_dir', default='/media/lz-4060ti-linux/软件/pcs/PCS+PrimeK/results')
